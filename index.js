...
app.get("/get/friends", (req, res)=>{
    amount.find({}, (error, data)=>{
        if (error) {
            ...
            console.log(data)     //you should not log in real application because it takes time
            res.json(data)
        }
    })
    
    // res.json({
    //     message: "Get the list of all bells and whistles for all friends"
    // })
})
...
// make this app listen to port 4211
let PORT = 4211

// if success, print in console
app.listen(PORT, ()=>{
